...
const Authentication = () => {
  ...
  return (
    <>
      <SEO 
        title="Member Authentication & Verification System"
        description="Verify UNCIF members, scholars, and frontliners through our secure digital authentication system. Enter unique identifier (UID) to authenticate institutes and individuals in the Uniford network."
        keywords="UNCIF authentication, Uniford verification, member verification, digital authentication, UID verification, institutes verification, frontliners authentication, CSR grants verification, Pitchburg, Un-pitch, Uniwave"
